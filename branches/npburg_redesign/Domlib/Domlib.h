...
enum ScryingPoolOpt
{
    SCRYING_DISCARD_CARD,
    SCRYING_PUT_BACK_CARD,
};
...
class __declspec(novtable) ICard
{
public:
    virtual ~ICard( void );
    ...
    virtual bool        IsReactionCard( void ) const = 0;
    virtual bool        IsDurationCard( void ) const = 0;
    virtual bool        IsTreasureCard( void ) const = 0;
    virtual bool        IsVictoryCard( void ) const = 0;
    virtual bool        IsCurseCard( void ) const = 0;
    virtual bool        IsNullCard( void ) const = 0;
...
class __declspec(novtable) IEngine
{
public:
    IEngine( void );
    virtual ~IEngine( void );

    virtual bool    IsCardInStock( ICard* card ) = 0;
    virtual bool    CardsAvailable( ICard* card ) = 0;
};
...
public:
    ...
    virtual void    RegisterAI( AI* pAi ) = 0;
    virtual void    RandomizeKingdomCards( int cardSet ) = 0;
    virtual void    Play( void ) = 0;
    virtual void*   GetResults( void ) = 0;
};
...
public:
    ...
    virtual ICardList   GetHand( void ) = 0;
    virtual int         HandSize( void ) = 0;
    virtual int         ActionsPlayed( void ) = 0;
    virtual int         GetCardCountInHandType( CARDTYPE cardType ) = 0;
};
