...
public:
    ...
    virtual Domlib::ICard*              PlayAction( void );

    // Return a Treasure card to play.
    virtual Domlib::ICard*              PlayTreasure( void );
    
    // Return a card to buy.
    virtual Domlib::ICard*              BuyCard( void );
    ...
    virtual Domlib::ICard*              OnAttack( Domlib::ICard* pAttackCard );

    // Return a card to gain up to the value of cost.
    virtual Domlib::ICard*              OnGainACard( const Domlib::ITreasure* cost );

    // Return a card to gain of the exact value of cost.
    virtual Domlib::ICard*              OnGainACardExactly( const Domlib::ITreasure* cost );
    ...
    virtual Domlib::ICardList           OnReturnToDrawPile( Domlib::ICardList cardList );

    // Return a card to trash from hand.
    virtual Domlib::ICard*              OnTrashCardFromHand( void );
    ...
    virtual Domlib::ICard*              OnIsland( void );
    ...
    // is played.
    virtual Domlib::NativeVillageOpt    OnNativeVillage( void );
    ...
    // is played.
    virtual Domlib::ICardList           OnNavigator( Domlib::ICardList cardList );
    ...
    virtual Domlib::ICardList           OnWarehouse( void );
    ...
    virtual Domlib::ICard*              OnContraband( void );
